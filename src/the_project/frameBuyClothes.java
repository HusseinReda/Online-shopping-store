...
public class frameBuyClothes extends javax.swing.JFrame {
    int index1,index2;
    ...
    private void initComponents() {
        ...
        boxType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "- - - - - - - - - - -", "Men Clothes", "Women Clothes", "Kids Clothes" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(221, 221, 221)
                                    .addComponent(back)))
                            .addComponent(boxTypeIn, javax.swing.GroupLayout.PREFERRED_SIZE, 402, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void boxTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxTypeActionPerformed
        ...
        if(boxType.getSelectedItem().equals("Men Clothes"))
        {
            for(int i=0;i<clothes.get(0).size();i++)
            boxTypeIn.addItem(clothes.get(0).get(i).toString());
        }
        else if(boxType.getSelectedItem().equals("Women Clothes"))
        {
            //     System.out.println("YES !!");
            for(int i=0;i<clothes.get(1).size();i++)
            boxTypeIn.addItem(clothes.get(1).get(i).toString());
        }
        else if(boxType.getSelectedItem().equals("Kids Clothes"))
        {
            for(int i=0;i<clothes.get(2).size();i++)
            boxTypeIn.addItem(clothes.get(2).get(i).toString());
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0;i<clothes.get(index1).size();i++)
        {
            if(clothes.get(index1).get(i).toString().equals(name))
                index2=i;
        }
        if(clothes.get(index1).get(index2).getQuantity()>=quantity)
        {
            int bate5a =clothes.get(index1).get(index2).getQuantity();
            clothes.get(index1).get(index2).setQuantity(bate5a-quantity);
            JOptionPane.showMessageDialog(null,"Purchasing Done Successfully !");
            BuyingList.BuyingListClothes.add(clothes.get(index1).get(index2));
        }
        else
        {
    ...
    private void boxTypeInItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_boxTypeInItemStateChanged
        ...
        jLabel3.setText(clothes.get(index1).get(index2).getPrice()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameBuyClothes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameBuyClothes().setVisible(true);
            }
        });
    }
